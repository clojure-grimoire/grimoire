...
The lib-grimoire `fs` backend relies on a datastore structured as follows:
...
/$GROUPID/notes.md
/$GROUPID/$ARTIFACTID/
/$GROUPID/$ARTIFACTID/meta.edn
/$GROUPID/$ARTIFACTID/notes.edn
/$GROUPID/$ARTIFACTID/$VERSION/
/$GROUPID/$ARTIFACTID/$VERSION/meta.edn
/$GROUPID/$ARTIFACTID/$VERSION/notes.md
/$GROUPID/$ARTIFACTID/$VERSION/$NAMESPACE/
/$GROUPID/$ARTIFACTID/$VERSION/$NAMESPACE/meta.edn
/$GROUPID/$ARTIFACTID/$VERSION/$NAMESPACE/notes.edn
/$GROUPID/$ARTIFACTID/$VERSION/$NAMESPACE/$SYMBOL/
/$GROUPID/$ARTIFACTID/$VERSION/$NAMESPACE/$SYMBOL/meta.edn
/$GROUPID/$ARTIFACTID/$VERSION/$NAMESPACE/$SYMBOL/notes.txt
/$GROUPID/$ARTIFACTID/$VERSION/$NAMESPACE/$SYMBOL/examples/
/$GROUPID/$ARTIFACTID/$VERSION/$NAMESPACE/$SYMBOL/examples/$EXAMPLE_ID.clj
```

This structure is trivially generated by tooling, as in the
[lein-grim](https://github.com/clojure-grimoire/lein-grim) program. It
also deliberately creates seperation of data between artifacts,
versions and groups meaning that it is safe to generate a composite
datastore by directly merging repos documenting single artifacts or
versions.
...
While Grimoire 0.3.X lacked a API for searching the backing datastore,
...
While this structure has no mandatory keys, the following are
cannonical values:
...
simply type selectors which return distinct subsets of these results.
